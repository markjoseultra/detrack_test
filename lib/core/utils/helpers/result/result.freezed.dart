...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( T result)?  success,TResult Function( CustomError error)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Success() when success != null:
return success(_that.result);case Failure() when failure != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( T result)  success,required TResult Function( CustomError error)  failure,}) {final _that = this;
switch (_that) {
case Success():
return success(_that.result);case Failure():
return failure(_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( T result)?  success,TResult? Function( CustomError error)?  failure,}) {final _that = this;
switch (_that) {
case Success() when success != null:
return success(_that.result);case Failure() when failure != null:
return failure(_that.error);case _:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Success<T>&&const DeepCollectionEquality().equals(other.result, result));
}
